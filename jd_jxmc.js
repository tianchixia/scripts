...
[task_local]
#京喜牧场
55 0,6-23/4 * * * jd_jxmc.js, tag=京喜牧场, img-url=https://github.com/58xinian/icon/raw/master/jdgc.png, enabled=true

================Loon==============
[Script]
cron "55 0,6-23/4 * * *" script-path=jd_jxmc.js,tag=京喜牧场

===============Surge=================
京喜牧场 = type=cron,cronexp="55 0,6-23/4 * * *",wake-system=1,timeout=3600,script-path=jd_jxmc.js

============小火箭=========
京喜牧场 = type=cron,script-path=jd_jxmc.js, cronexpr="55 0,6-23/4 * * *", timeout=3600, enable=true
 */
// prettier-ignore
